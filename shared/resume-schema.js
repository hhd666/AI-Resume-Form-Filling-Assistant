(function () {
  ...
  const SELECT_ALIAS_GROUPS = [
    ...
    { values: ["国家级", "national"] },
    { values: ["省级", "provincial"] },
    { values: ["校级", "school", "university"] },
    { values: ["学院级", "college", "department"] },
  ];
  ...
  const SECTION_DEFINITIONS = [
    ...
    },
    {
      ...
      note: "按照时间从近到远填写，不需要的条目留空。",
      fields: [
        { key: "name", label: "获奖名称", input: "text", placeholder: "国家奖学金" },
        { key: "date", label: "获奖时间", input: "date" },
        {
          key: "level",
          label: "奖项级别",
          input: "select",
          options: ["", "国家级", "省级", "校级", "学院级", "其他"],
        },
        { key: "rank", label: "奖项等级", input: "text", placeholder: "一等奖 / 金奖 / Top 10%" },
      ],
    },
    {
    ...
    {
      key: "patentsAndPapers",
      label: "专利与论文",
      type: "list",
      initialItems: 1,
      slots: 6,
      itemLabel: "专利/论文",
      note: "专利和论文统一填写，不需要的条目留空。",
      fields: [
        {
          key: "category",
          label: "类型",
        ...
        { key: "name", label: "名称", input: "text", placeholder: "专利名称 / 论文标题" },
        { key: "numberOrJournal", label: "编号/期刊", input: "text", placeholder: "专利编号 / 期刊名称" },
        { key: "description", label: "价值描述", input: "textarea", placeholder: "专利价值、论文贡献、影响力等" },
      ],
    },
    {
      key: "certificates",
    ...
    },
    {
      ...
      type: "group",
      fields: [
        { key: "awards0", label: "奖项荣誉", input: "textarea", placeholder: "奖学金、竞赛获奖、优秀员工等" },
